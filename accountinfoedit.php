...
<p class="emphasis"> Edit Account Information </p>
<P>

This is the information we currently have on file for your account:
<P>

Go ahead and change whatever information necessary, and we will update it for you.
<P>

<form method=post action="accountinfoupdate.php">
