<?php
	...
	if ($username == null) {
		$header = "<form method=post action=\"login.php\">
			...
			<input type=password value=Password name = \"pwd\" size=10>
			<br>
...
<body class="background">
	...
	<div class="content">
		<div class="left-content">
			...
			<?php echo $message; ?>
			<p class="emphasis">Welcome to Eagle Video!</p><br><br>
			Through this kiosk, you can access over 24,000 movies in less than 30 seconds.  Enter a search term, create an account, or log in to get started!<br><br>
		...
		<div class="right-content">
			...
			$custidrun = pg_query($dbconn,$custidquery);
			...
			$finalresult = pg_query($dbconn, $query5);
